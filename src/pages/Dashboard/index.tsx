...
export function Dashboard() {
  ...
  async function loadTransactions() {
    ...
    const transactionsFormateed: DataListProps[] = transactions.map(
      (item: DataListProps) => {
    ...
    const lastTransactionOuts = getLastTransactionDate(
      transactions,
      "negative"
    );
    const totalInterval =
      lastTransactionOuts === 0
        ? "Não há transações"
    ...
    setHighlightData({
      ...
      outs: {
        ...
        lasTransaction:
          lastTransactionOuts === 0
            ? "Não há transações"
            : `Última saída ${lastTransactionOuts}`,
      },
      total: {
        ...
        <>
          ...
          <HighlightCards>
            ...
            <HighlightCard
              ...
              lastTransaction={highlightData.outs?.lasTransaction}
            />
            <HighlightCard
              type="total"
              title="Total"
